          ...
          {filteredTickets.length > 0 ? (
            filteredTickets.map((ticket: Ticket, index: number) => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
              >
              <Card className="group h-full rounded-[1em] border-[#C0B7E8]/10 bg-[#3D3654] p-4 shadow-lg shadow-black/20 transition-all hover:border-[#C0B7E8]/30 hover:shadow-xl sm:p-6">
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex gap-2 border-t border-[#C0B7E8]/10 pt-3">
                    ...
                    <Button
                      ...
                      className="w-full rounded-[1em] hover:bg-[#302C42] text-[#E0E0E0]"
                    >
                    ...
                    <Button
                      ...
                      className="w-full rounded-[1em] hover:bg-red-900/20 text-red-400"
                    >
            ...
            >
            <Card className="rounded-[1em] border-[#C0B7E8]/10 bg-[#3D3654] p-12 text-center shadow-lg shadow-black/20">
